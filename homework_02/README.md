...
- Положить в A число 10
- Напечатать текущее A (в консоли появится 10)
- Проверить, не равно ли A нулю?
- Если равно — закончить работу и вернуть 0
- Уменьшить A на 1 (было 10, стало 9)
- Перейти обратно к шагу 2
- Повторять, пока A не станет 0
